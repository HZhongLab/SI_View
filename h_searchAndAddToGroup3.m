function h_searchAndAddToGroup3(handles)
...
% for i = 1:length(files)
%     FV_addToCurrentGroup(h_img3.(FVStructName).gh.currentHandles, files(i).name);
% end
h_addToCurrentGroup3(h_img3.(structName).gh.currentHandles, {files.name});%it can now handle many files in a string cell.
